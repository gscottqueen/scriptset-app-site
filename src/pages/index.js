...
const IndexPage = ({ data }) => (
  <div style={ wrapperStyles }>
    ...
    <div style={ asideStyles }>
      ...
      <h2 style={ leadintStyle }>We choose to be creators.</h2><p>To be part of the next chapter. We choose to work day and night, so you can be free to make the next great screenplay. We hope that you will join us on this exciting journey...for this, is just the begining.</p>
      <MailChimp/>
    </div>
  </div>
)
